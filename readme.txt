...
PageScale keeps the Pages screen fast on sites with tens of thousands of pages: lazy tree, virtual-scroll list, keyset pagination and indexed FULLTEXT search.
